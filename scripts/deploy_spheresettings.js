...
// proxyDeploy("SphereSettings", ["0x62f594339830b90ae4c084ae7d223ffafd9658a7"]).catch((error) => {
//   console.error(error);
//   process.exitCode = 1;
// });

// This is in order to push an update
// proxyPrepareUpgrade("SphereSettings", "0xc49be67aaa0a2476e5132ad77216521971643857").catch((err) => {
//   console.error(err);
//   process.exitCode = 1;
// })

// forceProxy("SphereSettings", "0xc49be67aaa0a2476e5132ad77216521971643857").catch((err) => {
//   console.error(err)
//   process.exitCode = 1;
// })

deploy("SphereSettings").catch((err) => {
  console.error(err);
  process.exitCode = 1;
})